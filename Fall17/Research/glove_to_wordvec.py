...
def get_lines(glove_file_name):
    ...
    with smart_open.smart_open(glove_file_name, 'r', encoding="Latin-1") as f:
...
glove_file="D:\\Research\\Data\\glove.6B\\glove.6B.300d.txt"

num_lines, dims = get_lines(glove_file)

# Output: Gensim Model text format.
gensim_file='D:\\Research\\Data\\glove.6B\\glove.6B.300d.2.txt'
...
print (model)
print (model.wv.most_similar(positive=['australia'], topn=10))
